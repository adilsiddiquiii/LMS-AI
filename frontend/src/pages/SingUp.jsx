...
function SingUp() {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      console.log(`handleSignUp function error ${error}`);
      setLoading(false);
      ...
      >
        ...
        <div className="md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3">
          <div>
            ...
            <h2 className="text-[gray] text-[18px]">Create Your Account</h2>
          </div>
          ...
          <div className="flex max-w-[50%] w-[70%] items-center justify-between">
            <span
              onClick={() => setRole("student")}
              className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-2xl cursor-pointer hover:border-black ${
